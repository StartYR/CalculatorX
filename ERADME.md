...
## 📝 项目简介
CalculatorPro 是一款运行在 HarmonyOS 上的高性能专业科学计算器。本项目采用现代化的“前端 UI + 离线 Web 渲染 + 底层 C++ 计算”三层架构，致力于提供媲美实体科学计算器的交互体验和出版级的数学公式排版。
...
- [ ] 重构 Index.ets 代码，将一个文件拆分为

- [ ] TODO: 唤醒 C++ 引擎，实现 N-API 数据通信。

- [ ] TODO: 在 C++ 端编写或接入 AST 解析器，啃下 LaTeX 字符串。
